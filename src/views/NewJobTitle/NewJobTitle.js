...
class NewJobTitle extends React.Component {
      ...
      <div>
          ...
          <GridItem xs={12} sm={12} md={12}>
            ...
            <Card>
              <CardHeader color="primary">
                <h4 className={classes.cardTitleWhite}>Add New Job Title</h4>
              </CardHeader>
              <CardBody>
              ...
              <GridContainer>
                  ...
                  <GridItem xs={12} sm={12} md={6}>
                    ...
                    <Button  color="primary">Add JobTitle</Button>
                    </div>
        ...
        <GridContainer>
          <GridItem xs={12} sm={12} md={12}>
            ...
            <Card>
              <CardHeader color="primary">
                <h4 className={classes.cardTitleWhite}>View Job Title</h4>
              </CardHeader>
              <CardBody>
              <Table
              ...
              tableData={[
                ["0", "Software Developer",<CancelIcon className={classes.cancelIcon}/>],
...
export default withStyles(styles)( NewJobTitle);
